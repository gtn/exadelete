...
$string['deleteusers_without_enrollments'] = 'Nutzer ohne Kurseinschreibung löschen';
$string['deleteusers_without_confirmation_message'] = 'Wollen sie wirklich diese Benutzer löschen?';
$string['withoutEnrollment_description'] = 'Nutzer ohne Kurseinschreibung löschen';
$string['delete_button'] = 'Löschen';
$string['task_delete_without_enrolement_and_anonymize'] = 'Nutzer ohne Kurseinschreibung löschen und Daten gelöschter Benutzer bereinigen';
